...
int main(int argc, char *argv[]) {
    ...
    int temp_min = get_min_min_temp(array);
    printf("\nLa temperatura minima registrada es de: %d\n", temp_min);

    int max_temperatures[YEARS];
    get_anual_max_max_temp(array, max_temperatures);

    month_t max_rainfall[YEARS];
    get_max_monthly_rainfall(array, max_rainfall);
