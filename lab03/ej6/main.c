...
/* Funciona más rapido la versión con punteros ya que estos almacenan directamente
la dirección de memoria a la cuál apuntan, por lo que no necesitan recorrer el archivo
en busca del elemento al que acceder para ejecutar las operaciones necesarias. */

/* Si no se emplea la funcion destroy la memoria no se liberaría, provocando que
memoria que no está en uso quede reservada, incluso cuando el programa ya se ejecutó. */